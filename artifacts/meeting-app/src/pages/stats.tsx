...
export default function Stats() {
  ...
  return (
    <div className="flex-1 flex flex-col pt-safe px-4 py-6 max-w-md mx-auto w-full">
      <h1 className="text-2xl font-serif font-bold text-foreground mb-8">Activity</h1>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-serif font-semibold text-foreground">Recent Meetings</h2>
          </div>
